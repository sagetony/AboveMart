...
var handleVisitorsAreaChart = function () {
    ...
    var color1 =
        $("#visitors-line-chart").attr("data-color") == "black" ? app.color.black : app.color.cyan
    var color2 =
        $("#visitors-line-chart").attr("data-color") == "black"
            ? "rgba(" + app.color.blackRgb + ", .5)"
            : app.color.blue
    ...
    nv.addGraph(function () {
        var stackedAreaChart = nv.models
            .stackedAreaChart()
...
var handleVisitorsDonutChart = function () {
    var color1 =
        $("#visitors-donut-chart").attr("data-color") == "black" ? app.color.black : app.color.blue
    var color2 =
        $("#visitors-donut-chart").attr("data-color") == "black"
            ? "rgba(" + app.color.blackRgb + ", .5)"
            : app.color.teal
    ...
    nv.addGraph(function () {
        ...
        d3.select("#visitors-donut-chart")
            .append("svg")
...
var handleVisitorsVectorMap = function () {
    if ($("#visitors-map").length !== 0) {
        var color1 =
            $("#visitors-map").attr("data-color") == "black" ? app.color.black : app.color.blue
        var color2 =
            $("#visitors-map").attr("data-color") == "black"
                ? "rgba(" + app.color.blackRgb + ", .5)"
                : app.color.teal
        var scaleColor = $("#visitors-map").attr("data-color")
            ? ["rgba(" + app.color.blackRgb + ", .5)", "rgba(" + app.color.blackRgb + ", .75)"]
            : [app.color.gray600, app.color.dark]
        var fillColor =
            $("#visitors-map").attr("data-color") == "black"
                ? "rgba(" + app.color.blackRgb + ", .25)"
                : app.color.gray600
        fillColor =
            $("#visitors-map").attr("data-color") == "white"
...
var handleScheduleCalendar = function () {
    $("#schedule-calendar").simpleCalendar({
        ...
        events: [
            ...
            {
                startDate: new Date(
                    new Date().setHours(new Date().getHours() - new Date().getHours() - 12, 0)
                ).toISOString(),
                endDate: new Date(
                    new Date().setHours(new Date().getHours() - new Date().getHours() - 11)
                ).getTime(),
                summary: "Restaurant",
            },
            {
...
var handleDashboardGritterNotification = function () {
    setTimeout(function () {
        $.gritter.add({
            ...
            text: "AboveMart offers her customers high in demand solutions with affiliate commission",
